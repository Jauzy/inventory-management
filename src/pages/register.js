...
import { register } from '../../static/redux/Actions/organization'
import { connect } from 'react-redux'

const Register = (props) => {
    const { dispatch, error, navigate } = props
    ...
    const [input, setInput] = useState({
        ...
        fullNameFocus: false,
        emailFocus: false,
        passwordFocus: false, submited: false
    })
                                        ...
                                        <CardBody className='mb-0'>
                                            <Form className="form mb-0">
                                                ...
                                                >
                                                    ...
                                                    <Input
                                                        value={input.organization_name}
                                                        onChange={onChange}
                                                        id='organization_name'
                                                        placeholder="Organization Name"
                                                        type="text"
                                                        onFocus={e =>
                                                            setInput({ ...input, fullNameFocus: true })
                                                        }
                                                        onBlur={e =>
                                                            setInput({ ...input, fullNameFocus: false })
                                                        }
                                                    />
                                                </InputGroup>
                                                <InputGroup
